...
/* * Funcion que inicializa la tabla que contendrá los caminos.
   * @param Tabla* tabla recibe la tabla donde se calcularán los caminos más cortos.
...
/* * Función que busca la posición de un nodo dentro de la tabla.
   * @param char vertex recibe un arreglo de vértices donde se va a buscar un nodo.
...
/* * Función que calcula la ruta mas corta basándose en la tabla que se ha calculado anteriormente.
